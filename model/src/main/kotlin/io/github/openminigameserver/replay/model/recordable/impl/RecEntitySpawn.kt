...
class RecEntitySpawn constructor(
    ...
    override fun provideRevertedActions(start: Duration, end: Duration, session: AbstractReplaySession): List<RecordableAction> = listOf(RecEntityRemove(position, entity))
}
